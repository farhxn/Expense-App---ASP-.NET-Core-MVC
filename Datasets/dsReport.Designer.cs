...
namespace Expense_App.Datasets {
    ...
    public partial class dsReport : global::System.Data.DataSet {
        ...
        public partial class transactionsDataTable : global::System.Data.TypedTableBase<transactionsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public transactionsRow AddtransactionsRow(int CategoryId, int Amount, string Note, System.DateTime Date) {
...
namespace Expense_App.Datasets.dsReportTableAdapters {
    ...
    public partial class transactionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [transactions] WHERE (([TransactionId] = @Original_TransactionId) AND ([CategoryId] = @Original_CategoryId) AND ([Amount] = @Original_Amount) AND ((@IsNull_Note = 1 AND [Note] IS NULL) OR ([Note] = @Original_Note)) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [transactions] ([CategoryId], [Amount], [Note], [Date]) VALUES (@Cate" +
                "goryId, @Amount, @Note, @Date);\r\nSELECT TransactionId, CategoryId, Amount, Note," +
                " Date FROM transactions WHERE (TransactionId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [transactions] SET [CategoryId] = @CategoryId, [Amount] = @Amount, [Note] = @Note, [Date] = @Date WHERE (([TransactionId] = @Original_TransactionId) AND ([CategoryId] = @Original_CategoryId) AND ([Amount] = @Original_Amount) AND ((@IsNull_Note = 1 AND [Note] IS NULL) OR ([Note] = @Original_Note)) AND ([Date] = @Original_Date));
SELECT TransactionId, CategoryId, Amount, Note, Date FROM transactions WHERE (TransactionId = @TransactionId)";
        ...
        private void InitConnection() {
            ...
            //this._connection.ConnectionString = global::WindowsFormsApp.Properties.Settings.Default.TransactionDBConnectionString;
        }
        ...
        public virtual int Fill(dsReport.transactionsDataTable dataTable) {
        ...
        public virtual dsReport.transactionsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsReport.transactionsDataTable dataTable = new dsReport.transactionsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsReport.transactionsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_TransactionId, int Original_CategoryId, int Original_Amount, string Original_Note, System.DateTime Original_Date) {
        ...
        public virtual int Insert(int CategoryId, int Amount, string Note, System.DateTime Date) {
        ...
        public virtual int Update(int CategoryId, int Amount, string Note, System.DateTime Date, int Original_TransactionId, int Original_CategoryId, int Original_Amount, string Original_Note, System.DateTime Original_Date, int TransactionId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CategoryId, int Amount, string Note, System.DateTime Date, int Original_TransactionId, int Original_CategoryId, int Original_Amount, string Original_Note, System.DateTime Original_Date) {
            return this.Update(CategoryId, Amount, Note, Date, Original_TransactionId, Original_CategoryId, Original_Amount, Original_Note, Original_Date, Original_TransactionId);
        }
    }
